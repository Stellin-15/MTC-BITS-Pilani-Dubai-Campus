  ...
  return (
    <div className="about-page">
      ...
      <div className="about-content">
        <h1>About Us</h1>
        <p>The Microsoft Tech Club is a student-led organization that is dedicated to fostering a community of like-minded individuals who are passionate about technology and innovation.</p>
        <p>Our goal is to provide members with opportunities to learn, grow, and connect with each other. Join us today and become a part of this exciting community!</p>
      </div>
        ...
        <div className="core-members">
          <div className="member">
            ...
            <div className="social-icons">
              <a href="https://www.instagram.com/aryan_scc/"><FaInstagram /></a>
              <a href="https://www.linkedin.com/in/aryan-satwani-43a46a211/"><FaLinkedin /></a>
              <a href="https://www.linkedin.com/in/aryan-satwani-43a46a211/"><FaGithub /></a>
            </div>
          </div>
          <div className="member">
        ...
        <div className="events-team">
          ...
          <div className="member">
            ...
            <div className="social-icons">
              ...
              <a href="https://www.linkedin.com/in/mysha-iqbal-baaa87318/"><FaLinkedin /></a>
      ...
      <div className="marketing-team-section">
        ...
        <div className="marketing-team">
          ...
          <div className="member">
            ...
            <div className="social-icons">
              <a href="https://www.instagram.com/hanamubarack/"><FaInstagram /></a>
              <a href="http://www.linkedin.com/in/hana-riyas"><FaLinkedin /></a>
              <a href="https://github.com/Hana11-tech"><FaGithub /></a>
            </div>
          </div>
          <div className="member">
            ...
            <div className="social-icons">
              ...
              <a href="https://www.linkedin.com/in/ameiya-wankhede-7600912b1?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><FaLinkedin /></a>
      ...
      <div className="faculty-section">
        ...
        <div className="faculty">
          <div className="faculty-member">
            ...
            <div className="social-icons">
              <a href="https://www.instagram.com/mtcbpdc/"><FaInstagram /></a>
